...
from core.testing_examples.services import student_create
from core.testing_examples.tests.factories import (
    SchoolCourseFactory,
    SchoolFactory,
)
from core.utils.tests import faker


class StudentCreateTests(TestCase):
    @patch("core.testing_examples.services.students.school_list_school_courses")
    @patch("core.testing_examples.services.students.roster_create")
    def test_student_is_rostered_to_all_active_school_courses(self, roster_create_mock, school_courses_mock):
        ...
        for school_course in school_courses_mock.return_value:
            roster_create_mock.assert_called_with(
                school_course=school_course, student=student, start_date=start_date, end_date=school_course.end_date
            )
