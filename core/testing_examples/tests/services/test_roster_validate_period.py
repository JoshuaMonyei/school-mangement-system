...
from core.testing_examples.tests.factories import SchoolCourseFactory
...
class RosterValidatePeriodTests(TestCase):
    def test_service_does_not_raise_error_if_valid_period(self):
        ...
        roster_period_equal_to_course_period = {"start_date": course.start_date, "end_date": course.end_date}
    ...
    def test_services_raises_error_for_rosters_outside_period(self):
        ...
        for roster_period in [
            ...
            with self.assertRaisesMessage(
                ValidationError, ROSTER_VALIDATE_PERIOD_OUTSIDE_COURSE_PERIOD.format(school_course=course)
            ):
